...
export const settings: SimpleTranslationEntries = {
  ...
  "keyboard": "キーボード",
  "gameSpeed": "ゲームスピード",
  "hpBarSpeed": "HPバーの増減速度",
  "expGainsSpeed": "EXPバーの増加速度",
  "expPartyDisplay": "パーティの経験値取得表示",
  "skipSeenDialogues": "戦闘シーンのメッセージをスキップ",
  "battleStyle": "試合のルール",
  ...
  "candyUpgradeNotification": "アメのアップグレード通知",
  "passivesOnly": "パッシブのみ",
  "candyUpgradeDisplay": "アメのアップグレード表示",
  "icon": "アイコン",
  "animation": "アニメーション",
  "moveInfo": "技の情報表示",
